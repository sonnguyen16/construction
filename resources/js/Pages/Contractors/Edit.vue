<template>
  <AdminLayout>
    <template #header>Chỉnh sửa nhà thầu</template>
    <template #breadcrumb>Chỉnh sửa nhà thầu</template>
...
const submit = () => {
  form.post(route('contractors.update', props.contractor.id), {
    onSuccess: () => {
      showSuccess('Nhà thầu đã được cập nhật thành công.')
    }
  })
}
</script>
