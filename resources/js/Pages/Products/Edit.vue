<template>
  <AdminLayout>
    <template #header>Chỉnh sửa sản phẩm</template>
    <template #breadcrumb>Chỉnh sửa sản phẩm</template>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    />
                    <small class="form-text text-muted">Khi số lượng tồn kho giảm xuống dưới mức này, hệ thống sẽ hiển thị cảnh báo.</small>
...
import { showSuccess, formatNumberInput, parseCurrency, formatCurrency } from '@/utils'
...
const form = useForm({
  ...
  import_price: formatCurrency(props.product.import_price),
  export_price: formatCurrency(props.product.export_price),
  initial_stock: props.product.initial_stock,
  warning_threshold: props.product.warning_threshold,
