        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <Link :href="route('receipt-categories.create')" class="btn btn-sm btn-primary">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-for="category in receiptCategories.data" :key="category.id">
                    ...
                    <td>
                      <div class="btn-group">
                        <Link :href="route('receipt-categories.edit', category.id)" class="btn btn-xs btn-primary">
