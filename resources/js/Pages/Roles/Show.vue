      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="card card-info card-outline" style="max-height: calc(100vh - 200px); overflow-y: auto;">
            ...
            <div class="card-body">
              <div class="row">
                <div v-for="(modulePermissions, module, index) in groupedPermissions" :key="module" class="col-md-6 mb-3">
                  <div class="card h-100 shadow-sm">
                    ...
                    >
                      <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                          <i class="fas fa-folder mr-2"></i> {{ formatModuleName(module) }}
                        </h5>
                    ...
                    <div class="card-body" style="">
                      <div class="list-group">
                        <div v-for="permission in modulePermissions" :key="permission.id" class="list-group-item list-group-item-action d-flex align-items-center py-2">
        ...
        <div class="modal-content">
            ...
            <div class="d-flex justify-content-between mb-3">
              <div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="selectAll" v-model="selectAll" @change="toggleSelectAll">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr v-for="availableUser in filteredUsers" :key="availableUser.id">
                    ...
                    <td>
                      <img :src="availableUser.avatar" alt="Avatar" class="img-circle" style="width: 40px; height: 40px;" />
                    </td>
                    <td>{{ availableUser.name }}</td>
                    <td>{{ availableUser.email }}</td>
                    <td>
                      <span v-for="userRole in availableUser.roles" :key="userRole.id" class="badge badge-info mr-1 p-2">
                        {{ userRole.name }}
                      </span>
          ...
          <div class="modal-footer">
            ...
            >
              ...
              <span v-if="processing" class="spinner-border spinner-border-sm ml-1" role="status" aria-hidden="true"></span>
            </button>
          </div>
        </div>
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="alert alert-warning">
              ...
              Bạn có chắc chắn muốn xóa người dùng <strong>{{ selectedUserToRemove?.name }}</strong> khỏi vai trò <strong>{{ role.name }}</strong>?
            </div>
...
const assignUsers = () => {
  ...
  router.post(route('roles.assign-users', props.role.id), {
...
const removeUserFromRole = () => {
  ...
  router.post(route('roles.remove-user', {
    role: props.role.id,
