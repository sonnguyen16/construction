          ...
          <form @submit.prevent="submit">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="mt-2">
                  <img
                    :src="avatarPreview || user.avatar || 'https://adminlte.io/themes/v3/dist/img/user2-160x160.jpg'"
                    class="img-thumbnail"
            ...
            <div class="card-footer">
              ...
              <Link href="/users" class="btn btn-default ml-2"> <i class="fas fa-times mr-1"></i> Hủy </Link>
            </div>
          </form>
        </div>
      </div>
